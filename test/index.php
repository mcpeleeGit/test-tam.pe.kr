    ...
    <table border="1" cellpadding="6" style="border-collapse:collapse; min-width:700px;">
        ...
        <tbody>
            <tr>
                ...
                <td><span id="url-basic">https://test-tam.pe.kr/test/basic.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-basic-case1">https://test-tam.pe.kr/test/basic_case1.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-basic-case2">https://test-tam.pe.kr/test/basic_case2.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-basic-case3">https://test-tam.pe.kr/test/basic_case3.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-basic-case4">https://test-tam.pe.kr/test/basic_case4.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-basic-case5">https://test-tam.pe.kr/test/basic_case5.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-review1">https://test-tam.pe.kr/test/review1.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-review2">https://test-tam.pe.kr/test/review2.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-review3">https://test-tam.pe.kr/test/review3.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-badge">https://test-tam.pe.kr/test/badge.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-highlight">https://test-tam.pe.kr/test/highlight.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-coupon">https://test-tam.pe.kr/test/coupon.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-wowdiscount">https://test-tam.pe.kr/test/wowdiscount.php</span></td>
                <td>
            ...
            <tr>
                ...
                <td><span id="url-membership">https://test-tam.pe.kr/test/membership.php</span></td>
                <td>
