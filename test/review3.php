...
<head>
    ...
    <meta property="kakao:commerce:product_top_review_rating_icon" content="4.5">
    <meta property="kakao:commerce:product_top_review" content="가격이 합리적이고 퀄리티도 훌륭....">
    <meta property="kakao:commerce:product_top_review_image_url" content="https://test.com/image.png">
    <!-- 옵션 -->
    <meta property="kakao:template_type" content="commerce_topreview">
    <meta property="kakao:commerce:regular_price" content="30000">
    <meta property="kakao:commerce:discount_rate" content="22">
</head>
<body>
    <h1>리뷰형_3 상품 예시</h1>
    <p>이 페이지는 카카오 커머스 리뷰형_3 메타 태그 예시입니다.</p>
    <h2>head 내 메타태그 정보</h2>
    <p><strong>OG Tags</strong> (<!-- OG Tags -->)</p>
    ...
    <p><strong>Kakao Commerce Tags (리뷰형_3)</strong> (<!-- Kakao Commerce Tags (리뷰형_3) -->)</p>
    <p>※ <b>필수 항목</b></p>
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        ...
        <tr><td>kakao:commerce:product_top_review_rating_icon</td><td>4.5</td><td>필수</td></tr>
        <tr><td>kakao:commerce:product_top_review</td><td>가격이 합리적이고 퀄리티도 훌륭....</td><td>필수</td></tr>
        <tr><td>kakao:commerce:product_top_review_image_url</td><td>https://test.com/image.png</td><td>필수</td></tr>
    </table>
    <p>※ <b>옵션 항목</b></p>
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        <tr><th>property</th><th>content</th><th>구분</th></tr>
        <tr><td>kakao:template_type</td><td>commerce_topreview</td><td>옵션</td></tr>
