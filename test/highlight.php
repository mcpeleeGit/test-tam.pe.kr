...
<head>
    ...
    <meta property="kakao:commerce:highlight_extra_icon_url" content="https://test.com/icon.png">
    <meta property="kakao:commerce:highlight_text" content="한 달간 800명 이상 구매했어요">
    <!-- 옵션 -->
    <meta property="kakao:template_type" content="commerce_highlight">
    <meta property="kakao:commerce:regular_price" content="30000">
    <meta property="kakao:commerce:discount_rate" content="22">
</head>
<body>
    <h1>키컨텐츠 상품 예시</h1>
    <p>이 페이지는 카카오 커머스 키컨텐츠 메타 태그 예시입니다.</p>
    ...
    <p><strong>Kakao Commerce Tags (키컨텐츠)</strong> (<!-- Kakao Commerce Tags (키컨텐츠) -->)</p>
    <p>※ <b>필수 항목</b></p>
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        ...
        <tr><td>kakao:commerce:highlight_extra_icon_url</td><td>https://test.com/icon.png</td><td>필수</td></tr>
        <tr><td>kakao:commerce:highlight_text</td><td>한 달간 800명 이상 구매했어요</td><td>필수</td></tr>
    </table>
    <p>※ <b>옵션 항목</b></p>
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        <tr><th>property</th><th>content</th><th>구분</th></tr>
        <tr><td>kakao:template_type</td><td>commerce_highlight</td><td>옵션</td></tr>
