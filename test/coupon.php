...
<head>
    ...
    <meta property="kakao:commerce:coupon_title" content="와우카드 시크릿 이벤트">
    <meta property="kakao:commerce:coupon_desc" content="쿠폰문구 일이삼사오육칠팔">
    <!-- 옵션 -->
    <meta property="kakao:template_type" content="commerce_coupon">
    <meta property="kakao:commerce:regular_price" content="30000">
    <meta property="kakao:commerce:discount_rate" content="22">
</head>
<body>
    <h1>쿠폰형 상품 예시</h1>
    <p>이 페이지는 카카오 커머스 쿠폰형 메타 태그 예시입니다.</p>
    ...
    <p><strong>Kakao Commerce Tags (쿠폰형)</strong> (<!-- Kakao Commerce Tags (쿠폰형) -->)</p>
    <p>※ <b>필수 항목</b></p>
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        ...
        <tr><td>kakao:commerce:coupon_title</td><td>와우카드 시크릿 이벤트</td><td>필수</td></tr>
        <tr><td>kakao:commerce:coupon_desc</td><td>쿠폰문구 일이삼사오육칠팔</td><td>필수</td></tr>
    </table>
    <p>※ <b>옵션 항목</b></p>
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        <tr><th>property</th><th>content</th><th>구분</th></tr>
        <tr><td>kakao:template_type</td><td>commerce_coupon</td><td>옵션</td></tr>
