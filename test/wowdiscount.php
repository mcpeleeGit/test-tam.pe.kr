...
<head>
    ...
    <title>가격정보플러스_와우할인 상품 예시</title>
    <!-- OG Tags -->
    ...
    <!-- Kakao Commerce Tags (가격정보플러스_와우할인) -->
    ...
    <meta property="kakao:commerce:discount_highlight_tag" content="와우할인">
    <!-- 옵션 -->
    <meta property="kakao:template_type" content="commerce_wowdiscount">
    <meta property="kakao:commerce:discount_rate" content="22">
    <meta property="kakao:commerce:regular_price" content="30000">
</head>
<body>
    <h1>가격정보플러스_와우할인 상품 예시</h1>
    <p>이 페이지는 카카오 커머스 가격정보플러스_와우할인 메타 태그 예시입니다.</p>
    ...
    <p><strong>Kakao Commerce Tags (가격정보플러스_와우할인)</strong> (<!-- Kakao Commerce Tags (가격정보플러스_와우할인) -->)</p>
    <p>※ <b>필수 항목</b></p>
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        ...
        <tr><td>kakao:commerce:discount_highlight_tag</td><td>와우할인</td><td>필수</td></tr>
    </table>
    <p>※ <b>옵션 항목</b></p>
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        <tr><th>property</th><th>content</th><th>구분</th></tr>
        <tr><td>kakao:template_type</td><td>commerce_wowdiscount</td><td>옵션</td></tr>
