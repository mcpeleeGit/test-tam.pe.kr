...
<head>
    ...
    <title>리뷰형_2 상품 예시 - 필수/옵션 일부 누락 케이스3</title>
    <!-- OG Tags -->
    ...
    <meta property="kakao:commerce:product_review_rating_icon" content="4.5">
    <!-- 누락: kakao:commerce:product_review_count (필수) -->
    <!-- 옵션 모두 누락 -->
</head>
<body>
    <h1>리뷰형_2 상품 예시 - 필수/옵션 일부 누락 케이스3</h1>
    ...
    <table border="1" cellpadding="4" style="border-collapse:collapse;">
        ...
        <tr><td>kakao:commerce:product_review_rating_icon</td><td>4.5</td><td>필수</td></tr>
