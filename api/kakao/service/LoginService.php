...
class LoginService extends service {  
    ...
    public function callBackLogin($reqDto){
        $client_id = "4408b5bb51bdf4c89879e933556a21e8"; 
        $client_secret = "QZhr9itOs0mxVRDxIvuOfOLzjZMc5q1U"; 
        $redirect_uri = urlencode("http://".$hostname."/api/kakao/login/callBackLogin");
        $returnUrl = "https://kauth.kakao.com/oauth/token?grant_type=authorization_code&client_id=".$client_id."&redirect_uri=".$redirect_uri."&code=".$reqDto->$code."&client_secret=".$client_secret;
        $ch = curl_init();
