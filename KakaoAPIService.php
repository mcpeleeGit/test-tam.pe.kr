...
class KakaoAPIService {  
    ...
    private $HOST = $_SERVER['HTTP_HOST'];    

    private const $REST_API_KEY = "4408b5bb51bdf4c89879e933556a21e8";
    private const $REDIRECT_URI = urlencode("http://".$HOST."/PHPSimplePack.php");



    public function getKakaoLoginLink(){
        $kakaoLoginUrl = "https://kauth.kakao.com/oauth/authorize?client_id=".$REST_API_KEY."&redirect_uri=".$REDIRECT_URI."&response_type=code";
        echo($kakaoLoginUrl);
    }
