<?php
require('KakaoTranslateAPIService.php');
$KakaoTranslateAPIService = new KakaoTranslateAPIService();
?>
<!doctype html>
<html lang="kr">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade <?= $lang == "" ? 'show active' : '' ?>" id="PHP">
                        ...
                        <div id="Response" class="alert alert-success" role="alert" style="overflow:hidden;word-wrap:break-word;" class="w-100 p-3">
                            <?= json_encode($KakaoTranslateAPIService->translate("kr","en","문장 번역요청한 문장을 다양한 언어로 번역하는 API로써 입력된 텍스트를 기반으로 번역 텍스트 결과를 전달합니다. 한국어와 타언어간 번역외에도 타언어간 번역도 지원됩니다.")) ?>
                        </div>
                    </div>
                </div>
            </li>
            <li class="list-group-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade <?= $lang == "" ? 'show active' : '' ?>" id="PHP">
                        ...
                        문장 번역요청한 문장을 다양한 언어로 번역하는 API로써 입력된 텍스트를 기반으로 번역 텍스트 결과를 전달합니다. 한국어와 타언어간 번역외에도 타언어간 번역도 지원됩니다.
                        <div id="Response" class="alert alert-success" role="alert" style="overflow:hidden;word-wrap:break-word;" class="w-100 p-3">
                            <?= json_encode($KakaoTranslateAPIService->languageDetect("문장 번역요청한 문장을 다양한 언어로 번역하는 API로써 입력된 텍스트를 기반으로 번역 텍스트 결과를 전달합니다. 한국어와 타언어간 번역외에도 타언어간 번역도 지원됩니다.")) ?>
                        </div>
                    </div>
                </div>
            </li>                                         
