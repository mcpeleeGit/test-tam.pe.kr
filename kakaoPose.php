<?php
require('KakaoPoseAPIService.php');
$KakaoPoseAPIService = new KakaoPoseAPIService();
?>
<!doctype html>
<html lang="kr">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade <?= $lang == "" ? 'show active' : '' ?>" id="PHP">
                        ...
                        <div id="Response" class="alert alert-success" role="alert" style="overflow:hidden;word-wrap:break-word;" class="w-100 p-3">
                            <?= json_encode($KakaoPoseAPIService->pose("http://test-tam.pe.kr/test/child.jpg")) ?>
                        </div>
                    </div>
                </div>
            </li>
            <li class="list-group-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade <?= $lang == "" ? 'show active' : '' ?>" id="PHP">
                        ...
                        <div id="Response" class="alert alert-success" role="alert" style="overflow:hidden;word-wrap:break-word;" class="w-100 p-3">
                            json_encode($KakaoPoseAPIService->poseJob("http://test-tam.pe.kr/test/fashion.jpg")) 
                        </div>
                    </div>
                </div>
            </li>
            <li class="list-group-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade <?= $lang == "" ? 'show active' : '' ?>" id="PHP">
                        ...
                        <div id="Response" class="alert alert-success" role="alert" style="overflow:hidden;word-wrap:break-word;" class="w-100 p-3">
                            json_encode($KakaoPoseAPIService->poseResult("http://test-tam.pe.kr/test/treatment.jpg")) 
                        </div>
                    </div>
                </div>
            </li>
